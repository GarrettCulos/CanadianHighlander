...
<div id="hl-header">
	...
	<div class="fluid-container">
		...
		<div class="input-group hl-top-nav">
			<div class="hl-left-container">
				<a  class=" nav-icon" href="<?php echo get_template_directory_uri() ?>/home">Canadian Highlander<span class="icons logo-icon"></span></a>
			</div>
		
			<div class="hl-search-container">
				<div class="hl-utility-bar">
					<span class="hl-utility-button"><img class="svg" src="<?php echo hl_get_svg_directory(); ?>/magnifying-glass.svg"></span>
					<input type="text" class="hl-form-control" placeholder="">				
				</div>
